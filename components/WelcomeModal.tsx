...
const WelcomeModal: React.FC<WelcomeModalProps> = ({ onNewCharacter, onNewComic, onNewUniverse, onNewProject, onNewBackground, onOpenProfile }) => {
    return (
            ...
            <div className="bg-panel-back rounded-xl shadow-2xl p-8 max-w-lg w-full text-center border border-panel-header">
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <button 
                        ...
                        className="p-4 bg-sky-500 text-white font-semibold rounded-lg hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-transform transform hover:scale-105 text-sm"
                    >
                        Nuevo Fondo
                    </button>
                     <button 
                        onClick={onOpenProfile}
                        className="p-4 bg-condorito-skin text-white font-semibold rounded-lg hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-condorito-skin transition-transform transform hover:scale-105 text-sm"
                    >
                        Perfil de Usuario
                    </button>
                </div>
