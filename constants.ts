...
export const PARAM_CONFIGS: Record<Exclude<CharacterParamKey, 'bodyOutlines' | 'eyeOutlines' | 'eyeStyle' | 'bodyColor' | 'irisColor' | 'outlineColor' | 'pupilColor' | 'headShape' | 'torsoShape' | 'eyeTracking' | 'pelvisShape' | 'eyelashes' | 'hair' | 'hairColor'>, ParamConfig> = {
  // Head
